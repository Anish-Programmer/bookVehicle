	...
	return (
		<div className='py-12'>
			<div className='container mx-auto px-4'>
				<h2 className='text-center text-5xl sm:text-6xl font-bold text-emerald-400 mb-4'>Available Now</h2>
					...
					<div className='overflow-hidden'>
						...
						>
							{availableVehicles?.map((vehicle) => (
								<div key={vehicle._id} className='w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex-shrink-0 px-2'>
